...
sed -i "s|aws.s3.bucketName=|aws.s3.bucketName=${BUCKET_NAME}|g" ${CATALINA_HOME}/webapps/alfresco/WEB-INF/classes/alfresco/module/alfresco-s3/alfresco-global.properties
